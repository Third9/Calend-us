...
var Menu = (function (_React$Component) {
  ...
  function Menu() {
    ...
    this.handleDocumentClick = function (event) {
      if (_this.state.active && !_utils2['default'].events.targetIsDescendant(event, _reactDom2['default'].findDOMNode(_this))) {
    ...
    this.handleSelect = function (item) {
      ...
      _this.setState({ value: value, active: false, rippled: _this.props.ripple }, function () {
        if (onClick) onClick();
        if (_this.props.onSelect) _this.props.onSelect(value, _this);
      });
    };
  }
  ...
  _createClass(Menu, [{
    ...
    value: function componentDidUpdate(prevProps, prevState) {
      if (prevState.active && !this.state.active) {
        ...
        _utils2['default'].events.removeEventsFromDocument({ click: this.handleDocumentClick });
    ...
    value: function componentWillUpdate(prevState, nextState) {
      if (!prevState.active && nextState.active) {
        _utils2['default'].events.addEventsToDocument({ click: this.handleDocumentClick });
      }
    }
  }, {
    ...
    value: function renderItems() {
      ...
      return _react2['default'].Children.map(this.props.children, function (item) {
        if (item.type === _menu_item2['default']) {
          return _react2['default'].cloneElement(item, {
            ripple: item.props.ripple || _this3.props.ripple,
            selected: item.props.value && _this3.props.selectable && item.props.value === _this3.state.value,
    ...
    value: function render() {
      ...
      var className = _styleMenu2['default'].root + ' ' + _styleMenu2['default'][this.state.position];
      if (this.state.active) className += ' ' + _styleMenu2['default'].active;
      if (this.state.rippled) className += ' ' + _styleMenu2['default'].rippled;
